package dev.stashy.extrasounds.mc1_21.runtime;
...
public class SoundImpl extends Sound implements VersionedSoundWrapper {
    public SoundImpl(Identifier id, FloatSupplier volume, FloatSupplier pitch, int weight, RegistrationType registrationType, boolean stream, boolean preload, int attenuation) {
    ...
    public static SoundImpl init(Identifier id, float volume, float pitch, int weight, RegistrationType registrationType, boolean stream, boolean preload, int attenuation) {
        return new SoundImpl(id, ConstantFloatProvider.create(volume), ConstantFloatProvider.create(pitch), weight, registrationType, stream, preload, attenuation);
    }
}
